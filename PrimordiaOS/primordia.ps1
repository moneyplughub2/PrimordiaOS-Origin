# PrimordiaOS v2 - Master Loader

$Global:PrimordiaRoot = "C:\Users\Shane\Documents\Dev\PrimordiaOS"
...
Write-Host "PrimordiaOS v2 loaded from $Global:PrimordiaRoot" -ForegroundColor Cyan
