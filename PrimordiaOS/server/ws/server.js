...
exports.startPrimordiaWSServer = startPrimordiaWSServer;
var ws_1 = require("ws");
var kernel_js_1 = require("../../kernel/core/kernel.js");
var interpreter_js_1 = require("../../kernel/runtime/interpreter.js");
function startPrimordiaWSServer(port) {
    var _this = this;
    ...
    wss.on("connection", function (socket) {
        ...
        socket.on("message", function (msg) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, (0, interpreter_js_1.interpretSentence)(text)];
                    case 2:
                        intent = _a.sent();
                    ...
                    case 3:
                        err_1 = _a.sent();
                        console.error("[PrimordiaOS] Interpreter error:", err_1);
                        return [3 /*break*/, 4];
        ...
        socket.on("close", function () {
            ...
            kernel_js_1.Kernel.emit("ws.server.closed");
        });
    });
    return wss;
}
